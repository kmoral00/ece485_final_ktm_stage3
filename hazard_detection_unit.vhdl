...
begin
    ...
    begin      
        ...
        elsif ((if_id_rd = rs1) and  (if_id_mem_read = '1' or if_id_load_addr = '1' or id_ex_mem_read = '1' or (opcode = "0000011" and if_id_opcode = "0010011"))) then -- single stall data dependency case <what control signales and opcodes> (if_id_opcode = "0010111" or if_id_opcode = "0110011" or if_id_opcode = "0010011" or if_id_opcode = "0000011")
                start_stall <= '1';
        elsif -- stall cases for branch or jump, needing time to calulate branch address, etc
              ((opcode = "1100011" and if_id_opcode = "0010011") or (if_id_opcode = "1100011" and opcode = "1101111")) then  --<what control signals and opcodes>
                start_stall <= '1';      
        else        
                start_stall <= '0';
        end if;    
